...
public class SourceMyCameraView extends SurfaceView implements SurfaceHolder.Callback,Camera.PreviewCallback{
     ...
     * @param camera
     */
    public SourceMyCameraView(Context context, Camera camera){
        super(context);
        con=context;
        mCamera=camera;
        mHolder=getHolder();
