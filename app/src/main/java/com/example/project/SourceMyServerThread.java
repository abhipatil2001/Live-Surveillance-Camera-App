...
public class SourceMyServerThread implements Runnable {
    private int mServerPort;
    private String mServerIP;
    private Context mContext;
    private Handler mHandler;
    private SourceMainActivity mActivityInstance;
    public SourceMyServerThread(Context context, String serverip, int serverport, Handler handler){
        super();
        mContext=context;
        mServerIP = serverip;
        mServerPort = serverport;
        mHandler = handler;
        mActivityInstance = (SourceMainActivity)mContext;
    }
    public void run(){
        try {
